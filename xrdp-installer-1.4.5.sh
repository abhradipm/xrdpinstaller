...
# Version : 1.4.5
# History : 1.4.5 - Specific changes for xubuntu on 22.04
...
sh_additional_credits()
{
    echo
/bin/echo -e "\e[1;36m   !----------------------------------------------------------------!\e[0m"
/bin/echo -e "\e[1;36m   ! *Oh no! Something has gone wrong error* fixed by Rituparna     !\e[0m" 
/bin/echo -e "\e[1;36m   !----------------------------------------------------------------!\e[0m"
echo
}
}
